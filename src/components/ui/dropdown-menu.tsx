...
>(({ className, sideOffset = 6, ...props }, ref) => (
	<DropdownMenuPrimitive.Content
		...
		className={cn(
			"z-50 min-w-[8rem] overflow-hidden rounded-2xl border bg-[var(--menu-solid)] p-2 text-[var(--sea-ink)] shadow-[0_18px_44px_var(--shadow-ink-20),0_6px_20px_var(--shadow-soft-10)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
			className,
		)}
		{...props}
	/>
